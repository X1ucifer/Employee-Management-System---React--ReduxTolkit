...
function SideBar({ setActiveMenu, activeMenu }) {
    ...
    const handleCloseSideBar = () => {
      ...
      const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-[#0D2F60] dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2';
